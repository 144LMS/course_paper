...
int main() {
	...
	int az[2][8][8], aSUMz[2][8][8], aSUMz1[2][8][8], aSUMp[2][8][8], a1[2][8][8], a2[2][8][8], a3[2][8][8], ochSUM[8], och[8][8], och1[8][8], och2[8][8], och3[8][8], o = 0, one = 1, two = 2, sum = 0, sum1 = 0, sumob = 0, max = 0, min = 0, m = 0, n = 0, ot[8], index = 0;
